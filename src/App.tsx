...
function App() {
  return (
    ...
    <div className="bg-ctp-base text-ctp-text w-full min-h-screen flex gap-3 p-5">
      ...
      <div className="flex flex-col w-1/7 gap-3">
        <button className="border-ctp-green-600 border-2 text-ctp-text px-8 py-4 w-full h-1/7 rounded-md text-center text-4xl ">
